...
class Main:
    ...
    def game_over(self):
        ...
        gameover_sur = game_font.render(text, pygame.Color("black"), True)
        gameover_x = int(cell_size * cell_num / 2)
        gameover_y = int(cell_size * cell_num / 2)
        gameover_rect = gameover_sur.get_rect(center=(gameover_x, gameover_y))

        back_rect = back.get_rect(center=(gameover_x, gameover_y))
        screen.blit(back, back_rect)

        newline_sur = game_font.render("hit the \"Space bar\" to play again or \" Esc\" to Quit", pygame.Color("black"), True)
        ...
        screen.blit(gameover_sur, gameover_rect)
